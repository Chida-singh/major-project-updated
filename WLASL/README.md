## Local note (this repo)

This folder is treated as a **local dataset/clone location**.

- Expected paths used by the pipeline scripts:
  - `WLASL/start_kit/WLASL_v0.3.json`
  - `WLASL/start_kit/videos/*.mp4`
- Git ignores everything under `WLASL/` except this README.
